      ...
      >
        ...
        >
          ...
          >
            {/* <List sx={{ cursor: 'pointer' }}>
    {sidebarItems.map(item => {
      // Check if the menu or any of its submenu items is active
      const isActiveMenu =
        ...
        <Box key={item._id}>
          ...
          <ListItem
            ...
            sx={{
              mt: 1,
              borderRadius: '10px',
              backgroundColor: isActiveMenu ? '#E0F7FA' : 'transparent',
              transition: 'background-color 0.3s, color 0.3s',
              '&:hover': {
                color: '#fff',
                backgroundColor: '#00ACC1',
          ...
          >
            ...
            {!isCollapsed && (
              <ListItemText primary={item.label} sx={{ ml: -2 }} className="menu-text" />
            )}
                  ...
                  return (
                    <ListItem
                      ...
                      sx={{
                        mt: 1,
                        borderRadius: '10px',
                        backgroundColor: isActiveSubmenu ? '#E0F7FA' : 'transparent',
                        color: 'black',
                        pl: 4,
                        transition: 'background-color 0.3s, color 0.3s',
                        '&:hover': {
                    ...
                    >
                      <ListItemIcon sx={{ fontSize: '1.2rem' }} className="menu-icon">
                        {iconMapping[subItem.icon]
                          ? React.createElement(iconMapping[subItem.icon])
                          : null}
                      </ListItemIcon>
                      {!isCollapsed && (
                        <ListItemText
          ...
          {/* <List>
            {newSidebarItems.map(item => (
              <ListItem key={item._id} component={ Link} to={item.path } className="menu-item" onClick={() => {
                ...
                <ListItemIcon sx={{ fontSize: '1.5rem', color: '#00ACC1' }} className="menu-icon">
                  {iconMapping[item.icon] ? React.createElement(iconMapping[item.icon]) : null}
                </ListItemIcon>
